...
extension BudgetQueryFilter on QueryBuilder<Budget, Budget, QFilterCondition> {
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> userIdEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'userId',
        value: value,
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> userIdGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> userIdLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> userIdBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension BudgetQuerySortBy on QueryBuilder<Budget, Budget, QSortBy> {
  ...
  QueryBuilder<Budget, Budget, QAfterSortBy> sortByUserId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.asc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> sortByUserIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension BudgetQuerySortThenBy on QueryBuilder<Budget, Budget, QSortThenBy> {
  ...
  QueryBuilder<Budget, Budget, QAfterSortBy> thenByUserId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.asc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> thenByUserIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.desc);
    });
  }
...
extension BudgetQueryWhereDistinct on QueryBuilder<Budget, Budget, QDistinct> {
  ...
  QueryBuilder<Budget, Budget, QDistinct> distinctByUserId() {
    return QueryBuilder.apply(this, (query) {
...
extension BudgetQueryProperty on QueryBuilder<Budget, Budget, QQueryProperty> {
  ...
  QueryBuilder<Budget, int, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
